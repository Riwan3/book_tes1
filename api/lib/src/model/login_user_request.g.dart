...
class _$LoginUserRequest extends LoginUserRequest {
  ...
  factory _$LoginUserRequest(
      ...
      (new LoginUserRequestBuilder()..update(updates))._build();

  _$LoginUserRequest._({this.email, this.password}) : super._();
...
class LoginUserRequestBuilder
  ...
  _$LoginUserRequest _build() {
    final _$result =
        _$v ?? new _$LoginUserRequest._(email: email, password: password);
    replace(_$result);
    return _$result;
  }
}
