...
class BookApi {
  ...
  Future<Response<InlineResponse200>> apiBooksAddPost({ 
    ...
    try {
      ...
      _bodyData = _serializers.serialize(storeBookRequest, specifiedType: _type);
  ...
  Future<Response<InlineResponse2002>> apiBooksBookIdDelete({ 
    ...
    final _path = r'/api/books/{book_id}'.replaceAll('{' r'book_id' '}', bookId.toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        r'Accept': accept,
  ...
  Future<Response<InlineResponse2001>> apiBooksBookIdEditPut({ 
    ...
    final _path = r'/api/books/{book_id}/edit'.replaceAll('{' r'book_id' '}', bookId.toString());
    final _options = Options(
      method: r'PUT',
      headers: <String, dynamic>{
        r'Accept': accept,
