...
class UserApi {
  ...
  Future<Response<InlineResponse2004>> apiLoginPost({
    required String accept,
    required LoginUserRequest loginUserRequest,
    ...
    try {
      const _type = FullType(LoginUserRequest);
      _bodyData =
          _serializers.serialize(loginUserRequest, specifiedType: _type);
  ...
  /// Throws [DioError] if API call or serialization fails
  Future<Response<InlineResponse2003>> apiRegisterPost({
    required String accept,
    required StoreUserRequest storeUserRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(StoreUserRequest);
      _bodyData =
          _serializers.serialize(storeUserRequest, specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioError(
        requestOptions: _options.compose(
          _dio.options,
  ...
  /// Throws [DioError] if API call or serialization fails
  Future<Response<InlineResponse2005>> apiUserLogoutDelete({
    required String accept,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
